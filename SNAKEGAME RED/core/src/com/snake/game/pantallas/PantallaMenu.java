...
public class PantallaMenu implements Screen {
	...
	public void show() {
		...
		fondoMenu.setSize(ConfiguracionesServer.ANCHO, ConfiguracionesServer.ALTO); // Colocamos que la imagen de fondo tenga el ancho y alto de la pantalla
		...
		for (int i = 0; i < opciones.length; i++) {
			...
			opciones[i].setPosition((ConfiguracionesServer.ANCHO/5) - (opciones[i].getAncho() / 2),
					((ConfiguracionesServer.ALTO / 1.7f) + (opciones[0].getAlto() / 2f))
